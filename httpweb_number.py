        ...
        try:
            ...
            if _user_number:
                ...
                # Ввод данных о номере
                    ...
                    print(f'\n{COLOR_CODE["BLUE"]}{COLOR_CODE["BOLD"]}[+] {COLOR_CODE["LI_G"]}Проверьте эти ссылки (Мессенджеры и Социальные сети): {COLOR_CODE["RESET"]}')
                    print(f'{COLOR_CODE["BLUE"]}{COLOR_CODE["BOLD"]}[{COLOR_CODE["CYAN"]}0{COLOR_CODE["BLUE"]}] {COLOR_CODE["URL_L"]}{COLOR_CODE["UNDERLINE"]}https://www.instagram.com/accounts/password/reset{COLOR_CODE["RESET"]}{COLOR_CODE["DARK"]} - Поиск аккаунта в Instagram')
                    print(f'{COLOR_CODE["BLUE"]}{COLOR_CODE["BOLD"]}[{COLOR_CODE["CYAN"]}1{COLOR_CODE["BLUE"]}] {COLOR_CODE["URL_L"]}{COLOR_CODE["UNDERLINE"]}https://api.whatsapp.com/send?phone={COLOR_CODE["BLUE"]}{_user_number}{COLOR_CODE["URL_L"]}&text=Привет,%20это%20%20noblack-mail!{COLOR_CODE["RESET"]}{COLOR_CODE["DARK"]} - Поиск номера в WhatsApp')
                    print(f'{COLOR_CODE["BLUE"]}{COLOR_CODE["BOLD"]}[{COLOR_CODE["CYAN"]}2{COLOR_CODE["BLUE"]}] {COLOR_CODE["URL_L"]}{COLOR_CODE["UNDERLINE"]}https://facebook.com/login/identify/?ctx=recover&ars=royal_blue_bar{COLOR_CODE["RESET"]}{COLOR_CODE["DARK"]} - Поиск аккаунта FaceBook')
                    print(f'{COLOR_CODE["BLUE"]}{COLOR_CODE["BOLD"]}[{COLOR_CODE["CYAN"]}3{COLOR_CODE["BLUE"]}] {COLOR_CODE["URL_L"]}{COLOR_CODE["UNDERLINE"]}https://www.linkedin.com/checkpoint/rp/request-password-reset?{COLOR_CODE["RESET"]}{COLOR_CODE["DARK"]} - Поиск аккаунта Linkedin')
                    print(f'{COLOR_CODE["BLUE"]}{COLOR_CODE["BOLD"]}[{COLOR_CODE["CYAN"]}4{COLOR_CODE["BLUE"]}] {COLOR_CODE["URL_L"]}{COLOR_CODE["UNDERLINE"]}https://ok.ru/dk?st.cmd=anonymRecoveryStartPhoneLink{COLOR_CODE["RESET"]}{COLOR_CODE["DARK"]} - Поиск аккаунта OK')
                    print(f'{COLOR_CODE["BLUE"]}{COLOR_CODE["BOLD"]}[{COLOR_CODE["CYAN"]}5{COLOR_CODE["BLUE"]}] {COLOR_CODE["URL_L"]}{COLOR_CODE["UNDERLINE"]}https://twitter.com/account/begin_password_reset{COLOR_CODE["RESET"]}{COLOR_CODE["DARK"]} - Поиск аккаунта Twitter')
                    print(f'{COLOR_CODE["BLUE"]}{COLOR_CODE["BOLD"]}[{COLOR_CODE["CYAN"]}6{COLOR_CODE["BLUE"]}] {COLOR_CODE["URL_L"]}{COLOR_CODE["UNDERLINE"]}https://viber://add?number={COLOR_CODE["BLUE"]}{_user_number}{COLOR_CODE["RESET"]}{COLOR_CODE["DARK"]} - Поиск номера в Viber')
                    print(f'{COLOR_CODE["BLUE"]}{COLOR_CODE["BOLD"]}[{COLOR_CODE["CYAN"]}7{COLOR_CODE["BLUE"]}] {COLOR_CODE["URL_L"]}{COLOR_CODE["UNDERLINE"]}https://skype:{COLOR_CODE["BLUE"]}{_user_number}{COLOR_CODE["URL_L"]}?call{COLOR_CODE["RESET"]}{COLOR_CODE["DARK"]} - Звонок на номер с Skype')
                    print(f'{COLOR_CODE["BLUE"]}{COLOR_CODE["BOLD"]}[{COLOR_CODE["CYAN"]}8{COLOR_CODE["BLUE"]}] {COLOR_CODE["URL_L"]}{COLOR_CODE["UNDERLINE"]}https://t.me/{COLOR_CODE["BLUE"]}{_user_number}{COLOR_CODE["RESET"]}{COLOR_CODE["DARK"]} - Открыть аккаунт в Телеграмме')
                    print(f'{COLOR_CODE["BLUE"]}{COLOR_CODE["BOLD"]}[{COLOR_CODE["CYAN"]}9{COLOR_CODE["BLUE"]}] {COLOR_CODE["URL_L"]}{COLOR_CODE["UNDERLINE"]}tel:{COLOR_CODE["BLUE"]}{_user_number}{COLOR_CODE["RESET"]}{COLOR_CODE["DARK"]} - Звонок на номер с телефона')
                
                    # Всего лимитов
                    print(f'\n{COLOR_CODE["BLUE"]}{COLOR_CODE["BOLD"]}[+] '+
                        f'{COLOR_CODE["CYAN"]}Всего лимитов: '+
                        f'{str(_get_user_number_data.get("limit", self.__not_found_text))}{COLOR_CODE["RESET"]}')

                    input(f'{COLOR_CODE["BLUE"]}{COLOR_CODE["BOLD"]}[{COLOR_CODE["CYAN"]}!{COLOR_CODE["BLUE"]}] {COLOR_CODE["LI_G"]}' + 

...
class HttpWebIp:
    ...
    def print_ip_results(self) -> str:
        ...
        try:
            ...
            print(f'{COLOR_CODE["BLUE"]}{COLOR_CODE["BOLD"]}[#] {COLOR_CODE["LI_G"]}Ваш IP:' +
                f' {COLOR_CODE["DARK"]}{_my_ip}{COLOR_CODE["RESET"]}')
            
            _user_ip: str = input(f'{COLOR_CODE["BLUEN"]}{COLOR_CODE["BOLD"]}[*] {COLOR_CODE["LI_G"]}' + 
            ...
            # Если не ввели IP
                ...
                print(f'{COLOR_CODE["BLUE"]}[!] {COLOR_CODE["CYAN"]}Ошибка, введите IP! {COLOR_CODE["RESET"]}\n')
